...
export default function Cuenta() {
    ...
    return (
        <Layout>
            <div className="container rounded bg-white h-100">
            <div className="row">
                <div className="col-md-3 border-right mt-5">
                    <div className="d-flex flex-column align-items-center text-center p-3 "><img className="rounded-circle " width="150px" src={store.user[2]} /><span className="text-black-50">{store.user[1]}</span><span> </span></div>
                </div>
