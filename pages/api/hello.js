...
export default function handler(req, res) {
  ...
  if (req.method === 'GET') {
    ...
    const path = zpubNode.derivePath(`0/0`);//configuracion para poder crear direcciones a partir de llave publica, el ultimo cero es el concecutivo para dorecciones de recepción 
